...
if (isset($_POST["submit"])) {
    ...
    if ($result) {
        ...
        header("Location: search_ar.php?id=$row[id]");
    } else {
        ...
        <?php if (isset($_GET["msg"])) {
            ...
            <div class="card bg-white"  style="overflow: auto;">
                <form style="padding: 5px;" class="d-flex" role="search" action="" method="post">
                    <input style="padding: 10px;" class="form-control me-2" name="fullname" type="search" placeholder="الاسم" aria-label="Search">
                    <button class="btn btn-outline-success" type="submit" name="submit">البحث</button>
                </form>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr <?php if ($row["status"] === "lost") { echo 'class="table-danger"'; } else { echo 'class="table-success"'; }?>>
                                ...
                                <td scope="row">
                                    <a href="edit_ar.php?id=<?php echo $row["id"];?>"
                                    class="link-dark"><img src="./includes/icons8-edit-24.png"></a>
                                    <a href="delete_ar.php?id=<?php echo $row["id"];?>"
