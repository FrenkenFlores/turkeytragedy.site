            ...
            <div class="card d-flex justify-content-center">
                <form action="" method="post" style="min-width:300px; background-color: FDFDFD; padding: 20px;">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Full name" name="fullname" aria-label="fullname" aria-describedby="basic-addon1" value="<?php echo $row['name']?>">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea class="form-control" name="contacts" placeholder="Enter all available victims contacts." aria-label="With textarea" value="<?php echo $row['contacts']?>"></textarea>
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea class="form-control" name="comment" placeholder="Leave your comment, message, your own contacts, etc." aria-label="With textarea" value="<?php echo $row['comment']?>"></textarea>
                    </div>
                    <div class="input-group mb-3">
