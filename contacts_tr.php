    ...
    <body>
        ...
        <ul class="nav nav-pills bg-white" style="padding: 10px; border-radius: 4px; border-color: BFBFBF; border-width: 1px; border-style:solid; ">
                ...
                <li class="nav-item dropdown ms-auto">
                    ...
                    <li><a id="ae" class="dropdown-item" href="./contacts_ar.php">العربيه</a></li>
                    <li><a id="ru" class="dropdown-item" href="./contacts_ru.php">Русский</a></li>
                    </ul>
                </li>
            </ul>
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <div>
                            Telefon numaraları: +79253488305, +905418249413
                        </div>
                        <div>
                            e-posta: saifualdin.evloev@gmail.com
                        </div>
                        <div>
