        ...
        <div class="container">
            ...
            <div class="card d-flex justify-content-center">
                <form action="" method="post" style="min-width:300px; background-color: FDFDFD; padding: 20px;">
                    <h4>الإبلاغ</h4>
                    <p class="card-text"><small class="text-muted">قم بإضافة معلومة جديدة</small></p>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">الاسم الكامل</span>
                        <input type="text" class="form-control" placeholder="اضف الاسم" name="fullname" aria-label="fullname" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea class="form-control" name="contacts" placeholder="اضف شبكات التواصل و ارقام اقارب الضحية" aria-label="With textarea"></textarea>
                    </div>
                    <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">مكان السكن</span>
                            <input type="text" class="form-control" placeholder="اضف مكان سكن الضحية" name="location" aria-label="location" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">رسالة</span>
                        <textarea class="form-control" name="comment" placeholder="اترك رسالتك، مثل عمر الضحية، مرضه او غير ذلك" aria-label="With textarea"></textarea>
                    </div>
                    <div class="input-group mb-3">
                        <button style="width:40%;" type="submit" class="btn btn-dark mx-auto" name="submit">الإبلاغ</button>
                    </div>
                </form>
            </div>
        </div>
