        ...
        <div class="container">
            ...
            <div class="card d-flex justify-content-center">
                <form action="" method="post" style="min-width:300px; background-color: FDFDFD; padding: 20px;">
                    <h4>Обновить сведения</h4>
                    <div class="input-group mb-3">
                        <span class="input-group-text" id="basic-addon1">Полное имя</span>
                        <input type="text" class="form-control" placeholder="Добавьте имя жертвы" name="fullname" aria-label="fullname" aria-describedby="basic-addon1" value="<?php echo $row['name']?>">
                    </div>
                    <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea class="form-control" name="contacts" placeholder="Добавьте контакты для обратной связи" aria-label="With textarea" value="<?php echo $row['contacts']?>"></textarea>
                    </div>
                    <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Местоположение</span>
                            <input type="text" class="form-control" placeholder="Добавьте местоположение жертвы" name="location" aria-label="location" aria-describedby="basic-addon1" value="<?php echo $row['location']?>">
                    </div>
                    <div class="input-group mb-3">
                        <span class="input-group-text">Комментарий</span>
                        <textarea class="form-control" name="comment" placeholder="Оставьте свот комментарий: сообщение, номер телефона, возрасть дополнительные сведения, и т.д." aria-label="With textarea" value="<?php echo $row['comment']?>"></textarea>
                    </div>
                    <div class="input-group mb-3">
                        <div class="col d-flex justify-content-center">
                            <button style="width:80%;" type="submit" class="btn btn-dark mx-auto" name="submit">Обновить</button>
                        </div>
                        <div class="col d-flex justify-content-center">
